...
<script lang="ts">
	...
	import { TextStyle } from '@tiptap/extension-text-style';
	import Color from '@tiptap/extension-color';
	// ⚠️ Tiptap v3 : Table, TableRow, TableHeader et TableCell sont regroupés
	// dans le même paquet @tiptap/extension-table (exports nommés).
	// Les anciens paquets séparés (@tiptap/extension-table-row, etc.)
	// sont dépréciés et peuvent exporter `undefined` en import par défaut,
	// ce qui cassait le bouton "tableau".
