	...
	{#if editor}
		{#key updateTick}
			...
			<button onclick={() => fileInput.click()} disabled={isUploading} title="Image">
				{#if isUploading}
					<LoaderIcon size={15} strokeWidth={2} class="spin" />
				{:else}
...
<div class="editor-wrapper" class:uploading={isUploading}>
	...
	{#if isUploading}
		<div class="upload-overlay">
			<LoaderIcon size={22} strokeWidth={2} class="spin" />
...
<style>
	...
	.editor-wrapper.uploading :global(.ProseMirror) {
		opacity: 0.4;
	}
	...
	:global(.editor-wrapper .ProseMirror p:last-child) {
		margin-bottom: 0;
	}
	...
	:global(.editor-wrapper .ProseMirror h1:first-child),
	:global(.editor-wrapper .ProseMirror h2:first-child),
	:global(.editor-wrapper .ProseMirror h3:first-child) {
		margin-top: 0;
	}
	...
	:global(.editor-wrapper .ProseMirror ul ul),
	:global(.editor-wrapper .ProseMirror ol ol),
	:global(.editor-wrapper .ProseMirror ul ol),
	:global(.editor-wrapper .ProseMirror ol ul) {
		margin: 0.25rem 0;
	}

	/* Emphase / formatage inline */
	:global(.editor-wrapper .ProseMirror strong) {
		font-weight: 700;
	}
	:global(.editor-wrapper .ProseMirror em) {
		font-style: italic;
	}
	:global(.editor-wrapper .ProseMirror s) {
		text-decoration: line-through;
	}
	:global(.editor-wrapper .ProseMirror u) {
		text-decoration: underline;
	}

	/* Liens */
	:global(.editor-wrapper .ProseMirror a) {
		color: #b23a1f;
		text-decoration: underline;
	...
	/* Code inline (différent du bloc de code ci-dessous) */
	...
	:global(.editor-wrapper .ProseMirror blockquote p) {
		margin: 0;
	}
	...
	:global(.editor-wrapper .ProseMirror td p),
	:global(.editor-wrapper .ProseMirror th p) {
		margin: 0;
	}
	:global(.editor-wrapper .ProseMirror .selectedCell) {
		background: rgba(178, 58, 31, 0.08);
	}
	:global(.editor-wrapper .ProseMirror .column-resize-handle) {
		background: #b23a1f;
	}
</style>