...
<script lang="ts">
	...
	const message = $derived(page.url.searchParams.get('message') ?? 'Une erreur est survenue.');
</script>
...
<div class="archive">
	<div class="masthead">
		<span class="masthead__eyebrow">Connexion</span>
	</div>

	<div class="archive__inner">
		<div class="card">
			<span class="card__icon">
				<AlertIcon size={16} strokeWidth={1.75} />
			</span>

			<h1 class="title">Connexion impossible</h1>
